  ...
  return (
    <button
      ...
      className={cn(
        ...
        'rounded-full border border-border/50 bg-white/50 dark:bg-slate-800/50',
        'text-sm text-muted-foreground',
        'transition-all duration-300 ease-out',
        'hover:border-brand-cornflower/40 hover:bg-white/90 dark:hover:bg-slate-800/90 hover:shadow-sm',
        'hover:w-72',
    ...
    >
      ...
      <kbd
        className={cn(
          ...
          'group-hover:border-brand-cornflower/30 group-hover:bg-brand-cornflower/10 group-hover:text-brand-navy dark:group-hover:text-brand-cornflower'
        )}
      >
  ...
  return (
    <header
      ...
      className={cn(
        ...
        // Glass pill styling
        'rounded-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl',
        'border border-white/60 dark:border-slate-800/60 ring-1 ring-black/[0.03] dark:ring-white/[0.05]',
        'shadow-float',
        // Layout
